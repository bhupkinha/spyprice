                    ...
                    <div class="body">
                        ...
                        <div class="row">
                           ...
                           <div class="select-m">
                                ...
                                <div class="select-m">
                                <?= $this->Form->control('feature_id', ['name' => 'feature_id', 'class' => 'form-control select2', 'type' => 'select', 'options' => $features,  'empty' => 'Select feature']) ?>          
                                </div>
                                <br>
                              
                                <div class="select-m">
                                    <?= $this->Form->control('brand_id', ['class' => 'form-control select2', 'type' => 'select', 'options' => $brands, 'label' => 'Brand', 'empty' => 'Choose Brand']) ?>          
                                </div>
