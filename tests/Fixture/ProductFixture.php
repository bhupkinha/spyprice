...
class ProductFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'created' => '2018-04-13 17:24:01',
            'modified' => '2018-04-13 17:24:01'
        ],
    ];
}
